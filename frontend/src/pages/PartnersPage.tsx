  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
        Приглашайте друзей и получайте 5% кэшбек с каждого пополнения их баланса
      </Typography>
      ...
      {activeTab === 2 && (
        <Paper sx={{ p: 3 }}>
          ...
          <Stack spacing={3} sx={{ mt: 3 }}>
            ...
            <Box>
              <Typography variant="subtitle1" fontWeight={600} gutterBottom>
                2. Они пополняют баланс - вы зарабатываете
              </Typography>
              <Typography variant="body2" color="text.secondary">
                Получайте 5% кэшбек с каждого пополнения баланса ваших рефералов. Чем чаще они пополняют,
                тем больше вы зарабатываете. Кэшбек начисляется автоматически и мгновенно на ваш реферальный счет.
              </Typography>
            </Box>
            ...
            <Box>
              <Typography variant="subtitle1" fontWeight={600} gutterBottom>
                3. Используйте или переводите деньги
              </Typography>
              <Typography variant="body2" color="text.secondary">
                Переводите заработанные средства с реферального счета на основной и используйте для покупок
                или продвижения товаров. Деньги доступны сразу после начисления.
              </Typography>
            </Box>
            ...
            <Box>
              ...
              <Stack component="ul" spacing={1} sx={{ pl: 2 }}>
                <li>
                  <Typography variant="body2" color="text.secondary">
                    Кэшбек 5% начисляется с каждого пополнения баланса реферала
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2" color="text.secondary">
                    Кэшбек доступен сразу на реферальном счете
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2" color="text.secondary">
                    Минимальная сумма для перевода на основной счет - не ограничена
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2" color="text.secondary">
