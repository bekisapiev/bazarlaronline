-- ============================================================
-- Вставка категорий - упрощённая версия (без TRUNCATE)
-- Используйте этот скрипт если вы уже очистили таблицу вручную
...
-- ============================================================
-- Всего категорий:
-- - Уровень 1: 2 (Товары, Услуги)
-- - Уровень 2: 24 (12 товаров + 12 услуг)
-- - Уровень 3: 240 (120 товаров + 120 услуг)
-- ИТОГО: 266 категорий
-- ============================================================
